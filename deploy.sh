...
now -e MAILJET_PUBLIC=@mailjet_public -e MAILJET_PRIVATE=@mailjet_private -e GMAP_KEY=@gmapkey -e GANALYTICS=@ganalytics -e SENTRY_KEY=@sentrykey  && now alias && now scale marmt.io 1